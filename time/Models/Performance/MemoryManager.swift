...
class MemoryManager: ObservableObject {
    ...
    @Published private(set) var memoryMetrics: MemoryMetrics = .init()
    ...
    func getCachedData<T>(forKey key: String, as _: T.Type) -> T? {
    ...
    func getResource<T: AnyObject>(withKey key: String, as _: T.Type) -> T? {
