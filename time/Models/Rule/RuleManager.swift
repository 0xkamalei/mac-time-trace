...
class RuleManager: ObservableObject {
    ...
    private func evaluateCondition(_ condition: RuleCondition, against activity: Activity) -> Int? {
        ...
        case let .url(pattern, matchType):
        ...
        case let .documentPath(pattern, matchType):
    ...
    func applyRule(_ rule: Rule, to activity: Activity, projectManager _: ProjectManager) throws {
